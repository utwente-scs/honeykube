...
var (
	...
	hostname string = os.Getenv("MYSQL_DB_SERVICE_ADDR")
	dbname   string = os.Getenv("MYSQL_DB_NAME")
)
...
func readCatalogFile(catalog *pb.ListProductsResponse) error {
	...
	log.Info("successfully read products table.")
	return nil
}
