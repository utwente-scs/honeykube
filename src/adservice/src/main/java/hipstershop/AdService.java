  ...
  private static ImmutableListMultimap<String, Ad> createAdsMap() {
    Ad ad1 =
        Ad.newBuilder()
            ...
            .setText("SAMSUNG Galaxy A71 for sale. Get 20% off.")
            .build();
    Ad ad2 =
        Ad.newBuilder()
            .setRedirectUrl("/product/0PUK6V6EV0")
            .setText("XIAOMI Poco X3 for sale. Get 30% off.")
            .build();
    Ad ad3 =
        Ad.newBuilder()
            .setRedirectUrl("/product/OLJCESPC7Z")
            .setText("SAMSUNG Galaxy A51 for sale. Get 15% off.")
            .build();
    Ad ad4 =
        Ad.newBuilder()
            .setRedirectUrl("/product/LS4PSXUNUM")
            .setText("OPPO A15 for sale. Get 10% off.")
            .build();
    Ad ad5 =
        Ad.newBuilder()
            .setRedirectUrl("/product/1P92ZMY6FP")
            .setText("GARMIN vivoactive smartwatch for sale. Get 25% off.")
            .build();
    Ad ad6 =
        Ad.newBuilder()
            .setRedirectUrl("/product/89J2ZMU6KL")
            .setText("HUAWEI Watch GT smartwatch for sale. Get 20% off.")
            .build();
    Ad ad7 =
        Ad.newBuilder()
            .setRedirectUrl("/product/3ILZ5WE8Y")
            .setText("SAMSUNG Galaxy Watch for sale. Get 10% off.")
            .build();
    return ImmutableListMultimap.<String, Ad>builder()
        .putAll("smartphone", ad1, ad2, ad3, ad4)
        .putAll("smartwatch", ad5, ad6, ad7)
        .build();
  }
